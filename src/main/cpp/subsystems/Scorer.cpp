...
Scorer::Scorer(frc::TimedRobot *_robot) :
    ...
    scorerMotor(new valor::PhoenixController(valor::PhoenixControllerType::KRAKEN_X44, CANIDs::SCORER_WHEEL, valor::NeutralMode::Brake, scorerMotorInverted(), "baseCAN")),
