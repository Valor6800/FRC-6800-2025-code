...
Drivetrain2024::Drivetrain2024(frc::TimedRobot *_robot, valor::CANdleSensor *_leds) : valor::BaseSubsystem(_robot, "Drivetrain2024"),
...
void Drivetrain2024::configSwerveModule(int i)
{
   ...
   int MDY[] = MODULE_DIFF_YS;
    ...
    swerveModules.push_back(new valor::SwerveModule<SwerveAzimuthMotor, SwerveDriveMotor>(azimuthControllers[i], driveControllers[i], motorLocations[i]));
    swerveModules[i]->setMaxSpeed(driveMaxSpeed);

}

void Drivetrain2024::init()
{
...
std::vector<valor::SwerveModule<Drivetrain2024::SwerveAzimuthMotor, Drivetrain2024::SwerveDriveMotor> *> Drivetrain2024::getSwerveModules()
{
    return swerveModules;
}

double Drivetrain2024::angleWrap(double degrees)
{
...
void Drivetrain2024::assessInputs()
{
...
void Drivetrain2024::calculateCarpetPose()
{
...
//1.313793103448276*
void Drivetrain2024::analyzeDashboard()
{
...
void Drivetrain2024::assignOutputs()
{
...
frc::Pose2d Drivetrain2024::getPoseFromSpeaker() {
...
units::meter_t Drivetrain2024::getDistanceFromSpeaker() {
...
units::meter_t Drivetrain2024::getDistanceFromAmp(){
...
units::meters_per_second_t Drivetrain2024::getRobotSpeeds(){
...
void Drivetrain2024::getSpeakerLockAngleRPS(){
...
void Drivetrain2024::getAmpLockAngle(){
...
units::radian_t Drivetrain2024::getAngleError(){
...
void Drivetrain2024::setAlignmentAngle(Alignment align) {
    bool isRed = frc::DriverStation::GetAlliance() == frc::DriverStation::kRed;
...
double Drivetrain2024::clampAngleRadianRange(units::radian_t angle, double max){
    return ((angle)/(max)).to<double>();
}

frc::SwerveDriveKinematics<SWERVE_COUNT>* Drivetrain2024::getKinematics()
{
    return kinematics;
}

frc::Pose2d Drivetrain2024::getPose_m()
{
    return estimator->GetEstimatedPosition();
}

frc::Pose2d Drivetrain2024::getCalculatedPose_m()
{
    return calculatedEstimator->GetEstimatedPosition();
}

wpi::array<frc::SwerveModulePosition, SWERVE_COUNT> Drivetrain2024::getModuleStates()
{
...
void Drivetrain2024::drive(units::velocity::meters_per_second_t vx_mps, units::velocity::meters_per_second_t vy_mps, units::angular_velocity::radians_per_second_t omega_radps, bool isFOC){
...
void Drivetrain2024::driveRobotRelative(frc::ChassisSpeeds speeds) {
...
wpi::array<frc::SwerveModuleState, SWERVE_COUNT> Drivetrain2024::getModuleStates(units::velocity::meters_per_second_t vx_mps,
...
wpi::array<frc::SwerveModuleState, SWERVE_COUNT> Drivetrain2024::getModuleStates(frc::ChassisSpeeds chassisSpeeds)
{
...
frc::ChassisSpeeds Drivetrain2024::getRobotRelativeSpeeds(){
...
void Drivetrain2024::setSwerveDesiredState(wpi::array<frc::SwerveModuleState, SWERVE_COUNT> desiredStates, bool isDriveOpenLoop)
{
    for (int i = 0; i < SWERVE_COUNT; i++) {
...
frc2::FunctionalCommand* Drivetrain2024::getResetOdom() {
...
bool Drivetrain2024::isWheelSlip(int i)
{
...
void Drivetrain2024::setDriveMotorNeutralMode(valor::NeutralMode mode) {
    for (int i = 0; i < SWERVE_COUNT; i++)
    {
...
void Drivetrain2024::InitSendable(wpi::SendableBuilder& builder)
    {
