...
template <class T>
LaserProximitySensor<T>::LaserProximitySensor(frc::TimedRobot *_robot,
                                              const char *name)
    : LidarSensor<T>(_robot, name), DebounceSensor(_robot, name),
...
template <class T> void LaserProximitySensor<T>::reset() {
...
template <class T> T LaserProximitySensor<T>::getLidarData() {
  return LidarSensor<T>::getLatestSensorData();
}

template <class T> bool LaserProximitySensor<T>::isTriggered() {
