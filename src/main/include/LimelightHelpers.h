...
#ifndef ROBOT_SRC_MAIN_INCLUDE_LIMELIGHTHELPERS_H_
#define ROBOT_SRC_MAIN_INCLUDE_LIMELIGHTHELPERS_H_
...
inline void from_json(const wpi::json &j, RetroreflectiveResultClass &t) {
  t.m_CAMERATransform6DTARGETSPACE =
      j.at(internal::_key_transformCAMERAPOSE_TARGETSPACE)
          .get<std::vector<double>>();
  t.m_TargetTransform6DCAMERASPACE =
      j.at(internal::_key_transformTARGETPOSE_CAMERASPACE)
          .get<std::vector<double>>();
  t.m_TargetTransform6DROBOTSPACE =
      j.at(internal::_key_transformTARGETPOSE_ROBOTSPACE)
          .get<std::vector<double>>();
  t.m_ROBOTTransform6DTARGETSPACE =
      j.at(internal::_key_transformROBOTPOSE_TARGETSPACE)
          .get<std::vector<double>>();
  t.m_ROBOTTransform6DFIELDSPACE =
      j.at(internal::_key_transformROBOTPOSE_FIELDSPACE)
          .get<std::vector<double>>();
  ...
  t.m_TargetXDegreesCrosshairAdjusted =
      j.at(internal::_key_TargetXDegreesCrosshair).get<double>();
  t.m_TargetYDegreesCrosshairAdjusted =
      j.at(internal::_key_TargetYDegreesCrosshair).get<double>();
  t.m_TargetAreaNormalized =
      j.at(internal::_key_TargetAreaNormalized).get<double>();
  t.m_TargetCorners =
      j.at(internal::_key_corners).get<std::vector<std::vector<double>>>();
}
...
inline void from_json(const wpi::json &j, VisionResultsClass &t) {
  ...
  t.DetectionResults =
      j.at("Detector").get<std::vector<DetectionResultClass>>();
  t.ClassificationResults =
      j.at("Detector").get<std::vector<ClassificationResultClass>>();
}
...
#endif // ROBOT_SRC_MAIN_INCLUDE_LIMELIGHTHELPERS_H_
