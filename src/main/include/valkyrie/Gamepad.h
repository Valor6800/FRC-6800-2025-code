...
public:
   ...
   *
   * Deadband is the range of values where where the values can be varied
   * without changing the output response.
   *
   * For example, if the deadband is 0.1, then any values between -0.1 and 0.1
   * will all yield an output response of 0.
   *
   * @param deadband Deadband value for the X direction of the gamepad. Between
   * 0 and 1
   */
   ...
   * will all yield an output response of 0.
   *
   * @param deadband Deadband value for the Y direction of the gamepad. Between
   * 0 and 1
   */
   ...
   *
   * First, the gamepad's raw X value is compared against the set deadband. See
   * the
   * @link setDeadbandX @endlink function. If the input is inside the deadband,
   * the output is set to 0. Otherwise, the gamepad's raw X value is raised to
   * the power of the input polynomial. For example, if polynomial parameter is
   * 2, then the input is squared (x^2).
   *
   ...
   *
   * First, the gamepad's raw Y value is compared against the set deadband. See
   * the
   * @link setDeadbandY @endlink function. If the input is inside the deadband,
   * the output is set to 0. Otherwise, the gamepad's raw Y value is raised to
   * the power of the input polynomial. For example, if polynomial parameter is
   * 2, then the input is squared (x^2).
   *
   * @param polynomial The exponent to apply to the gamepad's stick value
