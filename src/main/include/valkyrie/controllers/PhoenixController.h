...
public:
    ...
    void setupReverseHardwareLimit(int canID, ctre::phoenix6::signals::ReverseLimitTypeValue type, units::turn_t autosetLimit = 0_tr, bool saveImmediately = false);
    void setupForwardHardwareLimit(int canID, ctre::phoenix6::signals::ForwardLimitTypeValue type, units::turn_t autosetLimit = 0_tr, bool saveImmediately = false);
