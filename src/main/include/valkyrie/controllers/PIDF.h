...
struct PIDF {
  ...
  void setMaxVelocity(units::meters_per_second_t _maxVelocityMPS,
                      units::meter_t wheelDiameter) {
    units::turns_per_second_t _maxVelocity =
        _maxVelocityMPS * 1_tr / (M_PI * wheelDiameter);
    maxVelocity = _maxVelocity;
  }
  ...
  void
  setMaxAcceleration(units::meters_per_second_squared_t _maxAccelerationMPS,
                     units::meter_t wheelDiameter) {
    units::turns_per_second_squared_t _maxAcceleration =
        _maxAccelerationMPS * 1_tr / (M_PI * wheelDiameter);
    maxAcceleration = _maxAcceleration;
  }
