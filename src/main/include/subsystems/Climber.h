...
public:
  ...
  enum CLIMB_STATE { MANUAL, STOW, DEPLOYED, RETRACTED };

  enum STABBY_STATE { NO_CRAB, CRABBING };
...
private:
  ...
  frc::Alert climberPosSuccess{"Climber position is within tolerance",
                               frc::Alert::AlertType::kInfo};
  frc::Alert climberPosFail{"Climber position not within tolerance",
                            frc::Alert::AlertType::kError};
  // frc::Alert stabbySpeedSuccess{"Stabby speed is within tolerance",
  // frc::Alert::AlertType::kInfo}; frc::Alert stabbySpeedFail{"Stabby speed is
  // not within tolerance", frc::Alert::AlertType::kError};
};
